...
const Navbar = () => {
  return (
    <>
      <nav class="bg-gray-100 header-area shadow bg-opacity-70">
        <div class="container mx-auto px-32 py-3 md:flex md:justify-between md:items-center">
          <div class="flex justify-between items-center">
            <div>
              <Link
                style={{ color: "#354f52" }}
                class=" text-xl font-bold md:text-2xl hover:text-gray-700 "
                to="/"
              >
                E-Shop
              </Link>
