...
const Hero = ({ data }) => {
  ...
  return (
    <div className="min-w-full relative flex flex-col-reverse py-12 h-full lg:h-screen lg:pt-0 lg:flex-col lg:pb-0">
      ...
      {/* Banner Content */}
      <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-2 lg:max-w-screen-xl">
        <div className="my-16 lg:my-44 lg:max-w-lg lg:pr-5">
          ...
          <h2
            ...
            className="mb-5 font-display text-2xl font-semibold tracking-tight  sm:text-4xl lg:text-5xl sm:leading-none"
          >
            {title}
            <span className="inline-block">{titleColored}</span>
          </h2>
          ...
          <div className="flex items-center">
            <Link
              ...
              to="/shop"
              className="inline-flex items-center font-bold transition-colors text-white rounded-lg p-3 duration-200 text-red-accent-700 hover:text-gray-900 hover:bg-transparent  cursor-pointer"
            >
              Shop Now
              <svg
